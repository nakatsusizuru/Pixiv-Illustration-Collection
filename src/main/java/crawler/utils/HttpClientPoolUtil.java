...
public class HttpClientPoolUtil {
    ...
    static {
        ...
        manager.setMaxPerRoute(new HttpRoute(new HttpHost("app-api.pixiv.net", 443)), APP_API_PIXIV_NET_MAX_PRE_ROUTE);
        manager.setMaxPerRoute(new HttpRoute(new HttpHost("i.pximg.net", 443)), I_PXIMG_NET_MAX_PRE_ROUTE);
        manager.setMaxPerRoute(new HttpRoute(new HttpHost("oauth.secure.pixiv.net", 443)), OAUTH_SECURE_PIXIV_NET_MAX_PRE_ROUTE);
